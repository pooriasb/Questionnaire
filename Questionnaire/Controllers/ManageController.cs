...
namespace QuestionnaireProject.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // GET: /Account/Index
        [HttpGet]
        public async Task<ActionResult> Index(ManageMessageId? message,string Dashboard = "def")
        {
            ...
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "شماره تماس شما اضافه شد."
        ...
        [HttpPost]
        public async Task<ActionResult> VerifyPhoneNumberAndroid(string phoneNumber)
        {
            //todo add sms panel
            // This code allows you exercise the flow without actually sending codes
            // For production use please register a SMS provider in IdentityConfig and generate a code here.
        ...
        public async Task<ActionResult> ChangePasswordAndroid(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return Json(new {result=true, message = "رمز عبور با موفقیت تغییر یافت."});
            }
            return Json(new { result = false, message = "در سیسیتم خطایی رخ داده است." });
        }
